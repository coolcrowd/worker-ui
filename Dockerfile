...
RUN mv /build/localplatform.html /build/localplatformraw.html
...
ENTRYPOINT ["/bin/bash", "-c", "envsubst < /usr/share/nginx/html/debugraw.html > /usr/share/nginx/html/debug.html && envsubst < /usr/share/nginx/html/localplatformraw.html > /usr/share/nginx/html/localplatform.html && nginx -g 'daemon off;'"]